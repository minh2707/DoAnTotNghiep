...
{
    public partial class MigrationDauTien : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdKhachHang = table.Column<string>(type: "nvarchar(100)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_KhachHang_IdKhachHang",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HinhThucThanhToan = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    IDKhachHang = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChiTietDonHang_Product_ProductID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_IdKhachHang",
                table: "AspNetUsers",
                column: "IdKhachHang",
                unique: true,
